...
public class CassandraConnector {
	...
	public static Statement getConnection(String keyspace) throws Exception 
	{
		...
		try {
			prop.load(new FileInputStream("deneebolog4j/cassandra.properties"));
	   ...
	   // {
			try {
				...
				System.out.println("Trying to connect to "+keyspace+" Keyspace\n");
				con = DriverManager.getConnection("jdbc:cassandra://127.0.0.1:9160/"+keyspace);
				System.out.println("\nSuccessfully connected to "+keyspace+"\n");
				//break;
			}
			catch(Exception e)
			{
